...
public class TbWithholdingFileInfoExample {
    ...
    public TbWithholdingFileInfoExample() {
        oredCriteria = new ArrayList<Criteria>();
    }

    protected TbWithholdingFileInfoExample(TbWithholdingFileInfoExample example) {
