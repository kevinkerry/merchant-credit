...
public class DmMerchantDebitLogInfoExample {
    ...
    public DmMerchantDebitLogInfoExample() {
        oredCriteria = new ArrayList<Criteria>();
    }

    protected DmMerchantDebitLogInfoExample(DmMerchantDebitLogInfoExample example) {
