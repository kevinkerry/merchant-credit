...
public class DoMerchantApplyFailLogExample {
    ...
    public DoMerchantApplyFailLogExample() {
        oredCriteria = new ArrayList<Criteria>();
    }

    protected DoMerchantApplyFailLogExample(DoMerchantApplyFailLogExample example) {
