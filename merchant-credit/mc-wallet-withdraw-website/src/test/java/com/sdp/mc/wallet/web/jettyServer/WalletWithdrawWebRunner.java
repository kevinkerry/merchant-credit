package com.sdp.mc.wallet.web.jettyServer;
...
public class WalletWithdrawWebRunner {
	...
	public static void main(String[] args) throws Exception {
		...
		WebAppContext context = new WebAppContext("src/main/webapp", "/mc-wallet-withdraw-website");
