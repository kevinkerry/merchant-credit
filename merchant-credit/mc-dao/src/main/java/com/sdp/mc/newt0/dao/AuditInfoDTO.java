...
public class AuditInfoDTO extends NewT0AuditInfoDO {
	 /**
    ...
    private AuditInfoRequestLog marginInfo;
    
    private AuditInfoRequestAdustLog tempLimitInfo;
	...
	public AuditInfoRequestLog getMarginInfo() {
		return marginInfo;
	}

	public void setMarginInfo(AuditInfoRequestLog marginInfo) {
		this.marginInfo = marginInfo;
	}

	public AuditInfoRequestAdustLog getTempLimitInfo() {
		return tempLimitInfo;
	}

	public void setTempLimitInfo(AuditInfoRequestAdustLog tempLimitInfo) {
