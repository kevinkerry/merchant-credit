...
public class FundoutBankHelper {	
	...
	public static boolean isSupportDirectForCompany(String bankCode){
		...
		if(StringUtils.isNotBlank(bankCode)&&ALL_COMPANY_BANK_SUPPORT_DIRECT_LIST.get(bankCode) != null && ALL_COMPANY_BANK_SUPPORT_DIRECT_LIST.get(bankCode)){
